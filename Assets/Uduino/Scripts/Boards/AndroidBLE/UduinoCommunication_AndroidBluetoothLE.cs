...
namespace Uduino
{
    public class UduinoCommunication_AndroidBluetoothLE : MonoBehaviour
    {
        ...
        void OnBleDidInitialize(string message)
        {
            ...
            {
                UduinoInterface_Bluetooth.Instance.DisplayError("Cannot start BLE: " + message);
            }
        }
        ...
        void PeripheralScanComplete(string devices)
        {
            ...
            try
            {
                if (parsedData["devices"].Count == 0)
                {
                    ...
                    UduinoInterface_Bluetooth.Instance.NoDeviceFound(true);
                }
                else
                {
            ...
            UduinoInterface_Bluetooth.Instance.StopSearching();
        }
