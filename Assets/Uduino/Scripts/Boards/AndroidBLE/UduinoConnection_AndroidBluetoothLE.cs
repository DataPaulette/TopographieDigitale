...
namespace Uduino
{
    public class UduinoConnection_AndroidBluetoothLE : UduinoConnection
    {
        ...
        public override void ScanForDevices()
        {
            ...
            UduinoInterface_Bluetooth.Instance.StartSearching();
        }
        ...
        public void DeviceFound(string name, string uuid)
        {
            ...
            if (!availableDevices.ContainsKey(name))
            {
                ...
                UduinoInterface_Bluetooth.Instance.AddDeviceButton(name, uuid);
            }
        }
        ...
        public void DisconnectedFromSource()
        {
            ...
            {
                connectedDevice.OnBoardClosed -= DisconnectedFromSource;
                UduinoInterface_Bluetooth.Instance.UduinoDisconnected(connectedDevice.name);
        ...
        public override void PluginReceived(string message)
        {
            if (connectedDevice != null)
            {
                UduinoInterface_Bluetooth.Instance.LastReceviedValue(message);
