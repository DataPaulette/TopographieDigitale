...
namespace Uduino { 
    ...
    public class UduinoDevice_DesktopBluetoothLE : UduinoDevice {

        public UduinoDevice_DesktopBluetoothLE() : base() { }

        public UduinoDevice_DesktopBluetoothLE(UduinoConnection connection) : base()
        {
            _connection = connection;
            this.identity = "uduinoBLE";
        }

        public UduinoDevice_DesktopBluetoothLE(UduinoConnection connection, string identity) : base()
        {
            _connection = connection;
        ...
        {
            base.UduinoFound();
            UduinoInterface.Instance.UduinoConnected(this.name);
        }
